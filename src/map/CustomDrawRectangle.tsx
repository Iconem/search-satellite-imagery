// Forked from https://github.com/thegisdev/mapbox-gl-draw-rectangle-mode
// not used
...
const doubleClickZoom = {
  enable: (ctx) => {
    setTimeout(() => {
      ...
      if (!ctx.map?.doubleClickZoom || !ctx._ctx || !ctx._ctx.store || !ctx._ctx.store.getInitialConfigValue) return
